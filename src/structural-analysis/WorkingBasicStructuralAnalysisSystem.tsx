/**
 * Working Basic Structural Analysis System
 * Version sederhana yang functional dan bebas error TypeScript
 */
...
export const WorkingBasicStructuralAnalysisSystem = () => {
  // State
  ...
  const runAnalysis = useCallback(async () => {
    ...
    try {
      ...
      const results: BasicResults = {
        ...
        fundamentalPeriod: Math.sqrt(geometry.heightPerFloor * geometry.floors / 10),
        isValid: true
      };
          ...
          <TabsContent value="results">
            {results && (
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <Card>
                  <CardHeader>
                    <CardTitle>Periode Fundamental</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <p className="text-2xl font-bold text-purple-600">
                      {results.fundamentalPeriod.toFixed(3)} s
                    </p>
                  </CardContent>
                </Card>
              </div>
...
export default WorkingBasicStructuralAnalysisSystem;