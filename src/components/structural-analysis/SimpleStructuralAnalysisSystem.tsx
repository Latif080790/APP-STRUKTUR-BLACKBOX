  ...
  const runAnalysis = useCallback(async () => {
    ...
    try {
      ...
      const results: AnalysisResult = {
        ...
        baseShear: seismicParams.zoneFactor * materials.concrete.density * geometry.length * geometry.width * geometry.numberOfFloors,
        utilization: {
          maxStress: 0.85,
          safetyFactor: 2.5
        },
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => setMaterials(prev => ({ 
                            ...prev, 
                            concrete: { ...prev.concrete, fc: parseFloat(e.target.value) || 0 }
                          }))}
                        />
                      </div>
                      <div>
                        ...
                        <input
                          type="number"
                          className="w-full p-2 border rounded"
                          value={materials.steel.fy}
                          onChange={(e) => setMaterials(prev => ({ 
                            ...prev, 
                            steel: { ...prev.steel, fy: parseFloat(e.target.value) || 0 }
                          }))}
                        />
                      </div>
                    </div>
